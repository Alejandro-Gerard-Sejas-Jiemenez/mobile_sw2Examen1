...
Auditor Mobile Console — a companion Expo/TypeScript mobile app for a security-auditing platform.
Read-only client for auditors/analysts: authenticated session sync, real-time audit monitoring,
critical-finding push alerts, findings/evidence review, and executive report export.

Built with [Spec-Driven Development](https://github.com/github/spec-kit) — see
`specs/001-auditor-mobile-console/` for the spec, plan, and task breakdown, and
`.specify/memory/constitution.md` for the project's governing principles.
